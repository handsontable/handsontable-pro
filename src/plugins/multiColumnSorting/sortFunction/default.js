...
/**
 * Default sorting compare function factory. Method get as parameters `sortingState` and `columnMetas` and return compare function.
 *
 ...
 */
export default function defaultSort(sortingState, columnMetas) {
