...
/**
 * Numeric sorting compare function factory. Method get as parameters `sortStates` and `columnMetas` and return compare function.
 *
 ...
 */
export default function numericSort(sortStates, columnMetas) {
